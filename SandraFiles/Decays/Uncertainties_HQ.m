%Document from DecayWidth_HQ but including uncertanties
...
[I_if_square_cell, DeltaE, M] = ComputationIE(3, 1, 0.28, 0.861, 50);


file_name = 'GammaVSmass_HQcharm_2sd1-1p_uncert.txt';

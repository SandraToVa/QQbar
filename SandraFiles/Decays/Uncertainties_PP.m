%Document from DecayWidth_PP but including uncertanties
%The uncertanties calculation is done in a MonteCarlo procedure and uses
...
file_name = 'GammaVSmass_QQcharm_2p-1p_uncert.txt';

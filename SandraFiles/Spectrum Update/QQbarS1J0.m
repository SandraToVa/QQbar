%Functions to compute spectrum and w.f. of quarkonium with Jcal=0
% Quarkonium S=1, Jcal=0 they are P-states (J=0, L=1)
% Autor: Sandra Tomàs
% Creador subrutines i font: Ruben Oncala

function [E,W,x]=QQbarS1J0(m)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% with mixing of hybrids spin 0 and quarkonium spin 1: n=2
n=2;
system.A1= eye(n);
system.A2= zeros(n,n);
system.B1= eye(n);
...
%If mix=false is the same result as spin 0 because we don't have hyperfine
if mix == true
    r = zeros(2,2,4);

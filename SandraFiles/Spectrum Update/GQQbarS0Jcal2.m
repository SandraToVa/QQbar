%Functions to compute spectrum and w.f. of hybrids with J=2
% Hybrid S=0, Jcal=2, J=2 hey can be several states:
% - (P/F)_2-States L=1,L=3
% - D_2-States L=2
% Autor: Sandra Tomàs
% Creador subrutines i font: Ruben Oncala

function [E,W,x]=GQQbarS0Jcal2(m)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

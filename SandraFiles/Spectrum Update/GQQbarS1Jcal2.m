%Functions to compute spectrum and w.f. of hybrid spin 1 with Jcal=2
% Hybrid S=1, Jcal=2, J=1,2 they can be:
% - P_1-states L=1 J=1 (P_{12M}^{0-})
% - (S/D)_1-states L=0,2 J=1 (P_{12M}^{+-}, P_{12M}^{--}) wth this order
% - (P/D)_2-states L=1,3 J=2 (P_{12M}^{+0}, P_{12M}^{-0})
% - D_2-states L=2 J=2 (P_{12M}^{00})
% The order of the output wavefunction components is:
% R_{02M}, ( P_{12M}^{++}, P_{12M}^{-+}, P_{12M}^{+-}, P_{12M}^{--}, P_{12M}^{00}, 
% P_{12M}^{0+}, P_{12M}^{0-}, P_{12M}^{+0}, P_{12M}^{-0} )
% Autor: Sandra Tomàs
% Creador subrutines i font: Ruben Oncala

function [E,W,x]=GQQbarS1Jcal2(m)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% with mixing: 
%   - with hyperfine: spectrum from Ruben very non-degenerated (n=10)

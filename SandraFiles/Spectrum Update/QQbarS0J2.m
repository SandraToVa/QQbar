%Functions to compute spectrum and w.f. of quarkonium D-state
% Quarkonium S=0, Jcal=2, D-states (J=L=2)
% Autor: Sandra Tomàs
% Creador subrutines i font: Ruben Oncala

function [E,W,x]=QQbarS0J2(m)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% with mixing of hybrids spin 1 and quarkonium spin 0: n=6
n=6;
system.A1= eye(n);
system.A2= zeros(n,n);
system.B1= eye(n);
...
elseif mix == true
    ...
    for i=1:4
        ...
        [v12, v13, v14, v15, v16] = vOffDiagonalH1(x(i), j, m);

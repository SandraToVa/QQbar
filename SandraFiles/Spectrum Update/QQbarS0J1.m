%Functions to compute spectrum and w.f. of quarkonium P-state
% Quarkonium S=0, Jcal=1, P-states (J=L=1)
% Autor: Sandra Tomàs
% Creador subrutines i font: Ruben Oncala

function [E,W,x]=QQbarS0J1(m)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% with mixing of hybrids spin 1 and quarkonium spin 0: n=5
n=5;
system.A1= eye(n);
system.A2= zeros(n,n);
system.B1= eye(n);
...
elseif mix == true
    % In here P_1^-- does not exist, row 6 is now row 5
    r = zeros(5,5,4);
    for i=1:4
